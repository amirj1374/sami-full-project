...
public final class SalesInvoiceDtos {
    ...
    public record LineResponse(Long id,Long orderLineId,Long deliveryLineId,Long productId,Long variantId,String name,BigDecimal quantity,BigDecimal unitPrice,BigDecimal discount,BigDecimal lineTotal) { static LineResponse from(SalesInvoiceLine l){return new LineResponse(l.getId(),l.getOrderLineId(),l.getDeliveryLineId(),l.getProductId(),l.getVariantId(),l.getProductName(),l.getQuantity(),l.getUnitPrice(),l.getDiscount(),l.getLineTotal());} }
