...
public class SalesInvoiceLine extends BaseEntity {
    ...
    @Column(name="product_id",nullable=false) Long productId; @Column(name="variant_id") Long variantId; @Column(name="product_sku",nullable=false) String productSku; @Column(name="product_name",nullable=false) String productName;
