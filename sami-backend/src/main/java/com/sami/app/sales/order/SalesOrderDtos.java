...
public final class SalesOrderDtos {
    ...
    public record LineRequest(@NotNull Long productId, Long variantId, String serialNumber, String imei, @NotNull @DecimalMin("0.001") BigDecimal quantity,
        ...
        public LineRequest(Long productId, BigDecimal quantity, BigDecimal unitPrice, BigDecimal discount) {
            this(productId, null, null, null, quantity, unitPrice, discount);
        }
    }
    ...
    public record LineResponse(Long id, Long sourceLineId, Long productId, Long variantId, String serialNumber, String imei, String sku, String name,
        ...
        static LineResponse from(SalesOrderLine l) { return new LineResponse(l.getId(),l.getSourceLineId(),l.getProductId(),l.getVariantId(),l.getSerialNumber(),l.getImei(),l.getProductSku(),l.getProductName(),l.getQuantity(),l.getUnitPrice(),l.getDiscount(),l.getLineTotal(),l.getReservedQuantity(),l.getBackorderedQuantity(),l.getFulfilledQuantity()); }
    }
