...
export const vuetify = createVuetify({
    ...
    themes: {
      ...
      dark: {
        ...
        colors: {
          background: '#0E141F',
          surface: '#161D2B',
          'surface-bright': '#202A3C',
          'surface-container': '#192232',
  ...
  defaults: {
    VBtn: { flat: true, class: 'text-none font-weight-medium', rounded: 'lg' },
    VCard: { variant: 'flat', border: true, rounded: 'lg' },
    VSheet: { rounded: 'lg' },
    VTextField: { variant: 'outlined', density: 'comfortable', color: 'primary', hideDetails: 'auto', rounded: 'lg' },
    VTextarea: { variant: 'outlined', density: 'comfortable', color: 'primary', hideDetails: 'auto', rounded: 'lg' },
    VSelect: { variant: 'outlined', density: 'comfortable', color: 'primary', menuIcon: 'mdi-chevron-down', hideDetails: 'auto', rounded: 'lg' },
    VAutocomplete: { variant: 'outlined', density: 'comfortable', color: 'primary', menuIcon: 'mdi-chevron-down', hideDetails: 'auto', rounded: 'lg' },
    VCombobox: { variant: 'outlined', density: 'comfortable', color: 'primary', menuIcon: 'mdi-chevron-down', hideDetails: 'auto', rounded: 'lg' },
    VFileInput: { variant: 'outlined', density: 'comfortable', color: 'primary', hideDetails: 'auto', rounded: 'lg' },
    VChip: { label: true },
