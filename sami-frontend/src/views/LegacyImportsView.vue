    ...
    <v-row>
      <v-col cols="12" lg="4">
        <v-card rounded="xl" class="mb-4"><v-card-title>{{ t('legacy.newImport') }}</v-card-title><v-card-text>
          <v-file-input v-model="selectedFile" accept=".rar,.zip,application/vnd.rar,application/zip" prepend-icon="mdi-archive-arrow-up-outline" :label="t('legacy.chooseArchive')" :hint="t('legacy.archiveHint')" persistent-hint />
