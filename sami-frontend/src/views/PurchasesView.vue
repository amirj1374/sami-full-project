...
import GoodsReceiptsPanel from '@/components/purchasing/GoodsReceiptsPanel.vue'
import SupplierInvoicesPanel from '@/components/purchasing/SupplierInvoicesPanel.vue'
...
const tabs = computed(() => [
  ...
  { value: 'goods-receipts', label: 'Goods Receipts', icon: 'mdi-package-down', allowed: can('purchasing:view') },
  { value: 'supplier-invoices', label: 'Supplier Invoices', icon: 'mdi-file-document-check-outline', allowed: can('purchasing:view') },
...
<template>
  <div class="purchasing-page">
    ...
    <GoodsReceiptsPanel v-else-if="tab === 'goods-receipts' && can('purchasing:view')" />
    <SupplierInvoicesPanel v-else-if="tab === 'supplier-invoices' && can('purchasing:view')" />
